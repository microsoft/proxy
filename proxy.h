...
template <class F, inplace_proxiable_target<F> T, class... Args>
proxy<F> make_proxy_inplace(Args&&... args)
    noexcept(std::is_nothrow_constructible_v<T, Args...>) {
  return proxy<F>{std::in_place_type<details::inplace_ptr<T>>,
      std::forward<Args>(args)...};
}
template <class F, inplace_proxiable_target<F> T, class U, class... Args>
...
template <class F, proxiable_target<F> T, class U, class... Args>
