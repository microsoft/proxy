...
#define ___PRO_4_NO_UNIQUE_ADDRESS_ATTRIBUTE msvc::no_unique_address
#elif __has_cpp_attribute(no_unique_address)
#define ___PRO_4_NO_UNIQUE_ADDRESS_ATTRIBUTE no_unique_address
#else
#error Proxy requires C++20 attribute no_unique_address.
#endif

#if __cpp_exceptions >= 199711L
#define ___PRO_4_THROW(...) throw __VA_ARGS__
#else
...
template <facade F> class ___PRO_4_ENFORCE_EBO proxy;
...
struct copy_dispatch {
  ...
  ___PRO_4_STATIC_CALL(void, T&& self, proxy<F>& rhs)
...
struct destroy_dispatch {
  template <class T>
  ___PRO_4_STATIC_CALL(void, T& self) noexcept(std::is_nothrow_destructible_v<T>)
...
class inplace_ptr {
 ...
 private:
  [[___PRO_4_NO_UNIQUE_ADDRESS_ATTRIBUTE]]
  T value_;
};
...
class proxy : public details::facade_traits<F>::direct_accessor,
 ...
 public:
  ...
  proxy() noexcept { ___PRO_4_DEBUG(std::ignore = &_symbol_guard;) }
...
class ___PRO_4_ENFORCE_EBO allocated_ptr
...
template <class T, class Alloc>
struct ___PRO_4_ENFORCE_EBO compact_ptr_storage
...
template <class T, class Alloc>
struct ___PRO_4_ENFORCE_EBO shared_compact_ptr_storage
...
#define ___PRO_4_DEF_CAST_ACCESSOR(Q, SELF, ...) \
    template <class __F, bool __IsDirect, class __D, class T> \
    struct accessor<__F, __IsDirect, __D, T() Q> { \
      ___PRO_4_GEN_DEBUG_SYMBOL_FOR_MEM_ACCESSOR(operator T) \
...
struct cast_dispatch_base {
  ___PRO_4_DEF_MEM_ACCESSOR_TEMPLATE(___PRO_4_DEF_CAST_ACCESSOR,
      operator typename overload_traits<__Os>::return_type)
};
#undef ___PRO_4_DEF_CAST_ACCESSOR

struct upward_conversion_dispatch : cast_dispatch_base<false, true> {
  template <non_proxy_arg T>
  ___PRO_4_STATIC_CALL(T&&, T&& self) noexcept { return std::forward<T>(self); }
};
...
struct view_conversion_dispatch : cast_dispatch_base<false, true> {
  template <non_proxy_arg T>
  ___PRO_4_STATIC_CALL(auto, T& value) noexcept
...
struct weak_conversion_dispatch : cast_dispatch_base<false, true> {
  ...
  ___PRO_4_STATIC_CALL(auto, const P& self) noexcept
      requires(
...
struct format_dispatch {
  ...
  ___PRO_4_STATIC_CALL(OutIt, const T& self, std::basic_string_view<CharT> spec,
...
struct proxy_cast_accessor_impl {
  ...
  friend T proxy_cast(_Self self) {
    ...
    if constexpr (std::is_lvalue_reference_v<T>) {
      ...
      if (result == nullptr) [[unlikely]] { ___PRO_4_THROW(bad_proxy_cast{}); }
      ...
      proxy_invoke<IsDirect, D, O>(
          access_proxy<F>(std::forward<_Self>(self)), ctx);
      if (!result.has_value()) [[unlikely]] { ___PRO_4_THROW(bad_proxy_cast{}); }
...
#define ___PRO_4_DEF_PROXY_CAST_ACCESSOR(Q, ...) \
...
struct proxy_cast_dispatch {
  template <non_proxy_arg T>
  ___PRO_4_STATIC_CALL(void, T&& self, proxy_cast_context ctx) {
  ...
  ___PRO_4_DEF_FREE_ACCESSOR_TEMPLATE(___PRO_4_DEF_PROXY_CAST_ACCESSOR)
};
#undef ___PRO_4_DEF_PROXY_CAST_ACCESSOR
...
#define ___PRO_4_DEF_LHS_UNARY_OP_ACCESSOR ___PRO_4_DEF_LHS_ANY_OP_ACCESSOR
#define ___PRO_4_DEF_LHS_BINARY_OP_ACCESSOR ___PRO_4_DEF_LHS_ANY_OP_ACCESSOR
#define ___PRO_4_DEF_LHS_ALL_OP_ACCESSOR ___PRO_4_DEF_LHS_ANY_OP_ACCESSOR
#define ___PRO_4_LHS_LEFT_OP_DISPATCH_BODY_IMPL(...) \
    template <details::non_proxy_arg T> \
    ___PRO_4_STATIC_CALL(decltype(auto), T&& self) \
        ___PRO_4_DIRECT_FUNC_IMPL(__VA_ARGS__ std::forward<T>(self))
#define ___PRO_4_LHS_UNARY_OP_DISPATCH_BODY_IMPL(...) \
    template <details::non_proxy_arg T> \
    ___PRO_4_STATIC_CALL(decltype(auto), T&& self) \
        ___PRO_4_DIRECT_FUNC_IMPL(__VA_ARGS__ std::forward<T>(self)) \
    template <details::non_proxy_arg T> \
    ___PRO_4_STATIC_CALL(decltype(auto), T&& self, int) \
        ___PRO_4_DIRECT_FUNC_IMPL(std::forward<T>(self) __VA_ARGS__)
#define ___PRO_4_LHS_BINARY_OP_DISPATCH_BODY_IMPL(...) \
    template <details::non_proxy_arg T, class Arg> \
    ___PRO_4_STATIC_CALL(decltype(auto), T&& self, Arg&& arg) \
        ___PRO_4_DIRECT_FUNC_IMPL( \
            std::forward<T>(self) __VA_ARGS__ std::forward<Arg>(arg))
#define ___PRO_4_LHS_ALL_OP_DISPATCH_BODY_IMPL(...) \
    ___PRO_4_LHS_LEFT_OP_DISPATCH_BODY_IMPL(__VA_ARGS__) \
    ___PRO_4_LHS_BINARY_OP_DISPATCH_BODY_IMPL(__VA_ARGS__)
#define ___PRO_4_LHS_OP_DISPATCH_IMPL(TYPE, ...) \
    template <> \
    struct operator_dispatch<#__VA_ARGS__, false> { \
      ___PRO_4_LHS_##TYPE##_OP_DISPATCH_BODY_IMPL(__VA_ARGS__) \
      ___PRO_4_DEF_MEM_ACCESSOR_TEMPLATE( \
          ___PRO_4_DEF_LHS_##TYPE##_OP_ACCESSOR, operator __VA_ARGS__) \
    };

#define ___PRO_4_DEF_RHS_OP_ACCESSOR(Q, NE, SELF_ARG, SELF, ...) \
...
#define ___PRO_4_RHS_OP_DISPATCH_IMPL(...) \
    template <> \
    struct operator_dispatch<#__VA_ARGS__, true> { \
      ...
      ___PRO_4_DEF_FREE_ACCESSOR_TEMPLATE( \
          ___PRO_4_DEF_RHS_OP_ACCESSOR, __VA_ARGS__) \
    };

#define ___PRO_4_EXTENDED_BINARY_OP_DISPATCH_IMPL(...) \
    ___PRO_4_LHS_OP_DISPATCH_IMPL(ALL, __VA_ARGS__) \
    ___PRO_4_RHS_OP_DISPATCH_IMPL(__VA_ARGS__)

#define ___PRO_4_BINARY_OP_DISPATCH_IMPL(...) \
    ___PRO_4_LHS_OP_DISPATCH_IMPL(BINARY, __VA_ARGS__) \
    ___PRO_4_RHS_OP_DISPATCH_IMPL(__VA_ARGS__)

#define ___PRO_4_DEF_LHS_ASSIGNMENT_OP_ACCESSOR(Q, SELF, ...) \
    template <class __F, bool __IsDirect, class __D, class R, class Arg> \
    struct accessor<__F, __IsDirect, __D, R(Arg) Q> { \
      ___PRO_4_GEN_DEBUG_SYMBOL_FOR_MEM_ACCESSOR(__VA_ARGS__) \
...
#define ___PRO_4_DEF_RHS_ASSIGNMENT_OP_ACCESSOR(Q, NE, SELF_ARG, SELF, ...) \
    template <class __F, bool __IsDirect, class __D, class R, class Arg> \
    struct accessor<__F, __IsDirect, __D, R(Arg&) Q> { \
...
#define ___PRO_4_ASSIGNMENT_OP_DISPATCH_IMPL(...) \
    template <> \
    struct operator_dispatch<#__VA_ARGS__, false> { \
      template <details::non_proxy_arg T, class Arg> \
      ___PRO_4_STATIC_CALL(decltype(auto), T&& self, Arg&& arg) \
          ___PRO_4_DIRECT_FUNC_IMPL(std::forward<T>(self) __VA_ARGS__ \
              std::forward<Arg>(arg)) \
      ___PRO_4_DEF_MEM_ACCESSOR_TEMPLATE(___PRO_4_DEF_LHS_ASSIGNMENT_OP_ACCESSOR, \
    ...
    struct operator_dispatch<#__VA_ARGS__, true> { \
      ...
      ___PRO_4_STATIC_CALL(decltype(auto), T&& self, Arg&& arg) \
          ___PRO_4_DIRECT_FUNC_IMPL( \
              std::forward<Arg>(arg) __VA_ARGS__ std::forward<T>(self)) \
      ___PRO_4_DEF_FREE_ACCESSOR_TEMPLATE(___PRO_4_DEF_RHS_ASSIGNMENT_OP_ACCESSOR, \
          __VA_ARGS__) \
    };

___PRO_4_EXTENDED_BINARY_OP_DISPATCH_IMPL(+)
___PRO_4_EXTENDED_BINARY_OP_DISPATCH_IMPL(-)
___PRO_4_EXTENDED_BINARY_OP_DISPATCH_IMPL(*)
___PRO_4_BINARY_OP_DISPATCH_IMPL(/)
___PRO_4_BINARY_OP_DISPATCH_IMPL(%)
___PRO_4_LHS_OP_DISPATCH_IMPL(UNARY, ++)
___PRO_4_LHS_OP_DISPATCH_IMPL(UNARY, --)
___PRO_4_BINARY_OP_DISPATCH_IMPL(==)
___PRO_4_BINARY_OP_DISPATCH_IMPL(!=)
___PRO_4_BINARY_OP_DISPATCH_IMPL(>)
...
___PRO_4_BINARY_OP_DISPATCH_IMPL(<=)
___PRO_4_BINARY_OP_DISPATCH_IMPL(<=>)
___PRO_4_LHS_OP_DISPATCH_IMPL(LEFT, !)
___PRO_4_BINARY_OP_DISPATCH_IMPL(&&)
___PRO_4_BINARY_OP_DISPATCH_IMPL(||)
___PRO_4_LHS_OP_DISPATCH_IMPL(LEFT, ~)
___PRO_4_EXTENDED_BINARY_OP_DISPATCH_IMPL(&)
...
___PRO_4_BINARY_OP_DISPATCH_IMPL(<<)
___PRO_4_BINARY_OP_DISPATCH_IMPL(>>)
___PRO_4_ASSIGNMENT_OP_DISPATCH_IMPL(+=)
___PRO_4_ASSIGNMENT_OP_DISPATCH_IMPL(-=)
___PRO_4_ASSIGNMENT_OP_DISPATCH_IMPL(*=)
___PRO_4_ASSIGNMENT_OP_DISPATCH_IMPL(/=)
___PRO_4_ASSIGNMENT_OP_DISPATCH_IMPL(&=)
...
struct operator_dispatch<"()", false> {
  ...
  ___PRO_4_STATIC_CALL(decltype(auto), T&& self, Args&&... args)
      ___PRO_4_DIRECT_FUNC_IMPL(
          std::forward<T>(self)(std::forward<Args>(args)...))
  ___PRO_4_DEF_MEM_ACCESSOR_TEMPLATE(___PRO_4_DEF_LHS_ANY_OP_ACCESSOR, operator())
};
template <>
struct operator_dispatch<"[]", false> {
  ...
  template <details::non_proxy_arg T, class Arg>
  ___PRO_4_STATIC_CALL(decltype(auto), T&& self, Arg&& arg)
      ___PRO_4_DIRECT_FUNC_IMPL(std::forward<T>(self)[std::forward<Arg>(arg)])
#endif  // __cpp_multidimensional_subscript >= 202110L
  ___PRO_4_DEF_MEM_ACCESSOR_TEMPLATE(___PRO_4_DEF_LHS_ANY_OP_ACCESSOR, operator[])
};

#undef ___PRO_4_ASSIGNMENT_OP_DISPATCH_IMPL
#undef ___PRO_4_DEF_RHS_ASSIGNMENT_OP_ACCESSOR
#undef ___PRO_4_DEF_LHS_ASSIGNMENT_OP_ACCESSOR
#undef ___PRO_4_BINARY_OP_DISPATCH_IMPL
#undef ___PRO_4_EXTENDED_BINARY_OP_DISPATCH_IMPL
#undef ___PRO_4_RHS_OP_DISPATCH_IMPL
#undef ___PRO_4_DEF_RHS_OP_ACCESSOR
#undef ___PRO_4_LHS_OP_DISPATCH_IMPL
#undef ___PRO_4_LHS_ALL_OP_DISPATCH_BODY_IMPL
#undef ___PRO_4_LHS_BINARY_OP_DISPATCH_BODY_IMPL
#undef ___PRO_4_LHS_UNARY_OP_DISPATCH_BODY_IMPL
#undef ___PRO_4_LHS_LEFT_OP_DISPATCH_BODY_IMPL
#undef ___PRO_4_DEF_LHS_ALL_OP_ACCESSOR
#undef ___PRO_4_DEF_LHS_BINARY_OP_ACCESSOR
#undef ___PRO_4_DEF_LHS_UNARY_OP_ACCESSOR
#undef ___PRO_4_DEF_LHS_ANY_OP_ACCESSOR
#undef ___PRO_4_DEF_LHS_LEFT_OP_ACCESSOR
...
struct explicit_conversion_dispatch : details::cast_dispatch_base<true, false> {
  template <details::non_proxy_arg T>
  ___PRO_4_STATIC_CALL(auto, T&& self) noexcept
...
struct weak_dispatch : D {
  using D::operator();
  template <class... Args>
  [[noreturn]] ___PRO_4_STATIC_CALL(details::wildcard, Args&&...)
...
#undef ___PRO_4_NO_UNIQUE_ADDRESS_ATTRIBUTE
