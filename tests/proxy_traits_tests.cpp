...
static_assert(pro::diagnose_proxiable<MockMovablePtr, DefaultFacade>());
static_assert(pro::proxiable<MockCopyablePtr, DefaultFacade>);
static_assert(pro::diagnose_proxiable<MockCopyablePtr, DefaultFacade>());
static_assert(pro::proxiable<MockCopyableSmallPtr, DefaultFacade>);
static_assert(pro::diagnose_proxiable<MockCopyableSmallPtr, DefaultFacade>());
static_assert(pro::proxiable<MockTrivialPtr, DefaultFacade>);
static_assert(pro::diagnose_proxiable<MockTrivialPtr, DefaultFacade>());
static_assert(pro::proxiable<MockFunctionPtr, DefaultFacade>);
static_assert(pro::diagnose_proxiable<MockFunctionPtr, DefaultFacade>());
static_assert(std::is_nothrow_constructible_v<pro::proxy<DefaultFacade>, MockMovablePtr>);
static_assert(std::is_nothrow_assignable_v<pro::proxy<DefaultFacade>, MockMovablePtr>);
...
static_assert(pro::diagnose_proxiable<MockCopyablePtr, CopyableFacade>());
static_assert(pro::proxiable<MockCopyableSmallPtr, CopyableFacade>);
static_assert(pro::diagnose_proxiable<MockCopyableSmallPtr, CopyableFacade>());
static_assert(pro::proxiable<MockTrivialPtr, CopyableFacade>);
static_assert(pro::diagnose_proxiable<MockTrivialPtr, CopyableFacade>());
static_assert(pro::proxiable<MockFunctionPtr, CopyableFacade>);
static_assert(pro::diagnose_proxiable<MockFunctionPtr, CopyableFacade>());
...
static_assert(pro::diagnose_proxiable<MockCopyableSmallPtr, CopyableSmallFacade>());
static_assert(pro::proxiable<MockTrivialPtr, CopyableSmallFacade>);
static_assert(pro::diagnose_proxiable<MockTrivialPtr, CopyableSmallFacade>());
static_assert(pro::proxiable<MockFunctionPtr, CopyableSmallFacade>);
static_assert(pro::diagnose_proxiable<MockFunctionPtr, CopyableSmallFacade>());
...
static_assert(pro::diagnose_proxiable<MockTrivialPtr, TrivialFacade>());
static_assert(pro::proxiable<MockFunctionPtr, TrivialFacade>);
static_assert(pro::diagnose_proxiable<MockFunctionPtr, TrivialFacade>());
...
static_assert(pro::diagnose_proxiable<MockCopyableSmallPtr, RelocatableFacadeWithReflection>());
static_assert(pro::proxiable<MockTrivialPtr, RelocatableFacadeWithReflection>);
static_assert(pro::diagnose_proxiable<MockTrivialPtr, RelocatableFacadeWithReflection>());
static_assert(pro::proxiable<MockFunctionPtr, RelocatableFacadeWithReflection>);
static_assert(pro::diagnose_proxiable<MockFunctionPtr, RelocatableFacadeWithReflection>());
