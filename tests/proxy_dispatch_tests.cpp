...
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpPlus, "+");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpMinus, "-");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpAsterisk, "*");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpSlash, "/");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpPercent, "%");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpIncrement, "++");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpDecrement, "--");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpEqualTo, "==");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpNotEqualTo, "!=");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpGreaterThan, ">");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpLessThan, "<");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpGreaterThanOrEqualTo, ">=");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpLessThanOrEqualTo, "<=");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpSpaceship, "<=>");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpLogicalAnd, "&&");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpLogicalOr, "||");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpAmpersand, "&");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpPipe, "|");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpCaret, "^");
PRO_DEF_PRE_OPERATOR_DISPATCH(PreOpLeftShift, "<<");
